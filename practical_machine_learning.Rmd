...
trainResults <- data.frame(
  "DT" <- 
    ...
    paste(round((1-confusionMatrix(predict(decisionTreeModel,trainData[,-ncol(trainData)]), trainData$classe)$overall[1])*100, 3), " %"),  
  ...
  "RF" <- 
    ...
    paste(round((1-confusionMatrix(predict(randomForestModel,trainData[,-ncol(trainData)]), trainData$classe)$overall[1])*100, 3), " %"),  
