...
# Prediction Results
Having built the models, the classes of the dependent variable for each observation in the test data was predicted, starting with the least accurate classifier, Linear Discriminant Analsysi.
